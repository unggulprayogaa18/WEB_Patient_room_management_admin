    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data pasien tahun ini</h5>
        ...
        <div class="col-lg-6">
          ...
          <div class="card ">
            ...
            <div class="card-body">
              <div class="filter" style="padding-left: 420px;">
        ...
        <div class="col-lg-6">
          ...
          <div class="card ">
            ...
            <div class="flexx" style="display: flex;">
              <div class="card-body">
                <h5 class="card-title">woman <span>| This Year</span></h5>

                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i class="bi bi-people"></i>
                  </div>
                  <div class="ps-3 text-info">
                    <h6>14</h6>
              ...
              <div class="card-body">
                <h5 class="card-title">man <span>| This Year</span></h5>
