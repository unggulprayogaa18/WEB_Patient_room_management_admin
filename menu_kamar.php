...
if (isset($_SESSION['username'])) {
    ...
    $foto = isset($_SESSION['foto']) ? $_SESSION['foto'] : 'assets2/img/avatar.png'; // Gunakan default.png jika tidak ada foto

    try {
        // Gunakan koneksi PDO

        // Set mode error untuk PDO agar melempar pengecualian pada error
        ...
        // Ambil hasil fetch dalam bentuk array asosiatif
        ...
        if ($row) {
            $data_user = array(
                ...
                'foto' => $row['foto'] ?? $foto, // Gunakan foto dari database, jika tidak ada gunakan default
                'nama' => $row['nama']
            );
        } else {
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="config/uploads/<?php echo $foto; ?>" alt="foto" width="40" height="40"  class="rounded-circle">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="patientTable" class="table table-bordered text-center">
                                ...
                                <tbody id="tableforkamar" style="font-family: 'Space Mono', monospace;">
                                </tbody>
                            </table>
                        </div>
                                ...
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <form id="kamarForm">
                                        <div class="form-row">
                                            ...
                                            <div class="mb-3">
                                                <label for="nomer_kamar" class="form-label">nomer kamar:</label>
                                                <input type="text" class="form-control" id="nomer_kamar"
                                                    name="nomer_kamar" required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
    ...
    <script src="js/ajax-kamar.js"></script>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        generatePDF(response.data_kamar);
                    } else {
        ...
        function generatePDF(dataKamar) {
            // Create an HTML table using the dataPasien
            var tableHtml = '<table id="patientTable">';
            tableHtml += '<thead><tr><th>ID_kamar</th><th>Nomer_kamar</th><th>Status_kamar</th></thead>';
            tableHtml += '<tbody>';
