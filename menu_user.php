...
if (isset($_SESSION['username'])) {
    ...
    try {
        ...
        if ($row) {
            ...
            $response = array('status' => 'error', 'message' => 'Error in query: No data found');
        }
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="config/uploads/<?php echo $foto; ?>" width="40" height="40"  alt="Profile" class="rounded-circle">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="menu_user.php" class="active">
                        ...
                        <div class="card-body">
                            ...
                            <table id="patientTable" class="table-responsive overflow-auto">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody id="tableforuser" style="font-family: 'Space Mono', monospace;">
                                    </tbody>
                                </table>
                        </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        generatePDF(response.data_user);
                    } else {
